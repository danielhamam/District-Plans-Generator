    ...
    createClass(Canvas, [{
        ...
        value: function render() {
            ...
            if (this.state.debug !== null && _typeof(this.state.debug) === 'object' && this.state.debug.frameRate !== null) {
                ...
                debugElement = React.createElement(
                    'div',
                    { style: {
                            position: 'absolute',
                            top: 0,
            ...
            return React.createElement(
                aux,
                null,
                React.createElement('canvas', { className: this.props.className, style: this.props.style, ref: function ref(canvas) {
...
export { Canvas, Particle, Particles, importAllImages, importAll, hasProperty, isObject };
