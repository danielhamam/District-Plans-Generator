...
public class FakeDataAccessObject{
    ...
    public State buildNY(){
        ...
        NYPrecints[0] = (new Precinct("precinct" + 0, 0, null, new Demographic(10),null));
        NYPrecints[1] =(new Precinct("precinct" + 1, 1, null, new Demographic(10),null));
        NYPrecints[2] =(new Precinct("precinct" + 2, 2, null, new Demographic(10),null));
        NYPrecints[3] =(new Precinct("precinct" + 3, 3, null, new Demographic(10),null));
        NYPrecints[4] =(new Precinct("precinct" + 4, 4, null, new Demographic(10),null));
        NYPrecints[5] =(new Precinct("precinct" + 5, 5, null, new Demographic(10),null));
        NYPrecints[6] =(new Precinct("precinct" + 6, 6, null, new Demographic(10),null));
        NYPrecints[7] =(new Precinct("precinct" + 7, 7, null, new Demographic(10),null));
        NYPrecints[8] =(new Precinct("precinct" + 8, 8, null, new Demographic(10),null));
        NYPrecints[9] =(new Precinct("precinct" + 9, 9, null, new Demographic(10),null));
